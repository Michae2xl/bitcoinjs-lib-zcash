/**
 * Zcash address decode and encode tools, include base58、bech32 and output script
 *
 * networks support bitcoin、Zcash testnet and bitcoin regtest
 *
...
/**
 * Decodes a base58check encoded Zcash address and returns the version and hash.
 *
 * @param address - The base58check encoded Zcash address to decode.
...
/**
 * Converts an output script to a Zcash address.
 * @param output - The output script as a Buffer.
 * @param network - The Zcash network (optional).
 * @returns The Zcash address corresponding to the output script.
...
/**
 * Converts a Zcash address to its corresponding output script.
 * @param address - The Zcash address to convert.
 * @param network - The Zcash network to use. Defaults to the Zcash network.

...
describe('zcash', () => {
  ...
  describe('address.toBase58Check', () => {
    ...
    base58KeysValid.forEach(f => {
      ...
      const network: any = params.isTestnet
        ? zcash.networks.testnet
        : zcash.networks.bitcoin;
  ...
  describe('address.fromBase58Check', () => {
    const allowedNetworks = [
      zcash.networks.bitcoin.pubKeyHash,
      zcash.networks.bitcoin.scriptHash,
      zcash.networks.testnet.pubKeyHash,
      zcash.networks.testnet.scriptHash,
    ];

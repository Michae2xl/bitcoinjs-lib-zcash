...
import { reverseBuffer } from 'zcashjs-lib/src/bufferutils';
...
describe('zcashjs-lib (transactions w/ CSV)', () => {
  // force update MTP
  before(async () => {
  ...
  // Note: zcashjs-lib will not offer specific support for problems with

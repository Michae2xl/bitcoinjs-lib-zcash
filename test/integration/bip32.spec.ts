...
describe('zcashjs-lib (BIP32)', () => {
  it('can import a BIP32 testnet xpriv and export to WIF', () => {
    ...
    const node = bip32.fromBase58(xpriv, zcash.networks.testnet);
  ...
  it('can create a BIP49, Zcash testnet, account 0, external address', () => {
    const mnemonic =
    ...
    const { address } = bitcoin.payments.p2sh({
      redeem: bitcoin.payments.p2wpkh({
        ...
        network: zcash.networks.testnet,
      }),
      network: zcash.networks.testnet,
    });
